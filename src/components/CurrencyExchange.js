...
import AromaPrice from "./web3/AromaPrice";
      ...
      <CardContent>
        ...
        <Stack my={4} spacing={2.5} alignItems="center">
          ...
          <CurrencyInputField
            ...
            required
          />
          <LoadingButton color="secondary" size="xlarge" variant="contained" fullWidth onClick={handleExchange} loading={exchangeLoading} loadingPosition="end">
            {t("components.CurrencyExchange.exchangeButton")}
          </LoadingButton>
          <Chip
            label={"For 1 " + NETWORKS[TARGET_CHAIN].nativeToken + " you get " + <AromaPrice /> + " tokens"}
            sx={{ margin: "8px 0" }}
            size="small"
